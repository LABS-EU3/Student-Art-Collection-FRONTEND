...
import DisplayArtSchoolPageModal from '../Components/BuyModalComponents/DisplayArtSchoolPageModal';
import SuccessfulPurchase from '../Components/BuyModalComponents/SuccessfulPurchase';

function ArtSchoolPageViewModal(props) {
  ...
  return (
    <>
      ...
      {/* <Route
        ...
        path="/browse/success"
        render={props => (
          <SuccessfulPurchase {...props} closeModal={closeModal} />
        )}
      />
      <ToastContainer
...
export default connect(state => state, actionCreators)(ArtSchoolPageViewModal);
